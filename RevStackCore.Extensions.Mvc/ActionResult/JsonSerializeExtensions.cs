...
namespace RevStackCore.Extensions.Mvc
{
	public static class JsonSerializeExtensions
	{
		...
		public static string GetViewModel(this ITempDataDictionary tempData)
		{
		...
		public static void SetViewModel(this ITempDataDictionary tempData, string jsonModel)
		{
			tempData[JSON_VIEW_MODEL] = jsonModel;
		}

		public static void SetViewModelProp(this ITempDataDictionary tempData, string contextProperty)
		{
